    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 animate-fade-in mb-20">
      ...
      <div className="flex border-b">
        <button
          ...
          className={`px-8 py-4 font-black uppercase italic text-sm tracking-tighter transition-all relative ${activeTab === "progress" ? "text-primary" : "text-muted-foreground hover:text-primary/70"
            }`}
        >
          Tópicos de Estudo
        ...
        <button
          ...
          className={`px-8 py-4 font-black uppercase italic text-sm tracking-tighter transition-all relative ${activeTab === "schedule" ? "text-primary" : "text-muted-foreground hover:text-primary/70"
            }`}
        >
          Cronograma Semanal
                ...
                >
                  <div className="flex-1 space-y-4">
                    <div className="flex items-center gap-3">
                      <span className={`px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${block.userLevel === 3 ? 'bg-yellow-500/10 text-yellow-600' :
                      ...
                      <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {subtopics.map((topic, idx) => (
                          ...
                          >
                            ...
                            <ChevronRight className="h-3 w-3 ml-auto opacity-0 group-hover:opacity-100 transition-all" />
                          </Link>
                        ))}
                      </div>
                    </motion.div>
